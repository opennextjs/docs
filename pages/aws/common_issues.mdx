...
Also you should not add sharp as a dependency unless absolutely necessary, the image optimization already has it's own version of sharp. By default OpenNext does exclude these packages:
