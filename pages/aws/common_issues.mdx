...
This error will occur when the server function is called with a Server Action request without a body.

Make sure that the body is correctly forwarded to the server function. 