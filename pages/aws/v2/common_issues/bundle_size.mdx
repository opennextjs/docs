...
<Callout type="info" emoji="ℹ️">
  Next 14+ no longer includes dev dependencies like @swc, esbuild, etc... in the output node_modules, so
...
<Callout type="info" emoji="ℹ️">
  There is a [PR](https://github.com/sst/open-next/pull/242) to remove some dev dependency from the output
  node_modules but that requires more testing before it can merge.
</Callout>
