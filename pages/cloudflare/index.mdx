...
A headsup if you're trying to use this on a free tier is that currently the generated build is generally larger than 1 mb which the limit for the free tier.
